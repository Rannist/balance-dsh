...
`;
    ...
    function BalanceFooter({ wide }) {
      ...
      const openUsagePage = (e) => { e && e.preventDefault(); window.open("https://platform.deepseek.com/usage", "_blank", "noopener"); };
      ...
      const inner = [
        ...
        jsx.jsx("span", {
          className: "balance-footer__label",
          children: "余额",
        }),
        jsx.jsx("span", {
